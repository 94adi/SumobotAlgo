...
#define CNF_TPM0_CHANNEL1 		IO_TPM_GENERATE_CHANNEL(IO_TPM_DEVICE0, IO_TPM_CHANNEL1, IO_TPM_CH_CONFIG_PWM, 		IO_TPM_PWM_CHANNEL_INDEX0)
#define CNF_TPM0_CHANNEL2 		IO_TPM_GENERATE_CHANNEL(IO_TPM_DEVICE0, IO_TPM_CHANNEL2, IO_TPM_CH_CONFIG_PWM, 		IO_TPM_PWM_CHANNEL_INDEX1)
...
#define CNF_TPM1_CHANNEL0		IO_TPM_GENERATE_CHANNEL(IO_TPM_DEVICE1, IO_TPM_CHANNEL0, IO_TPM_CH_CONFIG_PWM, 		IO_TPM_PWM_CHANNEL_INDEX2)
#define CNF_TPM1_CHANNEL1		IO_TPM_GENERATE_CHANNEL(IO_TPM_DEVICE1, IO_TPM_CHANNEL1, IO_TPM_CH_CONFIG_DCM, IO_TPM_PWM_CHANNEL_INDEX_NOT_CONF)

#define CNF_TPM2_CHANNEL0 		IO_TPM_GENERATE_CHANNEL(IO_TPM_DEVICE2, IO_TPM_CHANNEL0, IO_TPM_CH_CONFIG_PWM, 		IO_TPM_PWM_CHANNEL_INDEX3)
#define CNF_TPM2_CHANNEL1		IO_TPM_GENERATE_CHANNEL(IO_TPM_DEVICE2, IO_TPM_CHANNEL1, IO_TPM_CH_CONFIG_DCM, 		IO_TPM_PWM_CHANNEL_INDEX_NOT_CONF)
