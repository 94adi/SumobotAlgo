...
const Io_Adc_config_channel config_adc_autoscan_channels[] =
{
...

				{
						23		, /* CH ID*/
						IO_ADC_INPUT_CLK_ACT | IO_ADC_CNV_MODE_10BIT | IO_ADC_SAMPLE_TIME_LONG | IO_ADC_INPUT_CLOCK_ACT, /*CFG1*/
						IO_ADC_SAMPLE_TIME_10CYCL | IO_ADC_CONV_SPEED_HIGH   /* CFG2*/
				},
				{
						9		, /* CH ID*/
						IO_ADC_INPUT_CLK_ACT | IO_ADC_CNV_MODE_10BIT | IO_ADC_SAMPLE_TIME_LONG | IO_ADC_INPUT_CLOCK_ACT, /*CFG1*/
...
{
		{
		sizeof(config_adc_autoscan_channels)/sizeof(Io_Adc_config_channel), //number_of_channels
		config_adc_autoscan_channels //*adc_config_channel
		}
};
