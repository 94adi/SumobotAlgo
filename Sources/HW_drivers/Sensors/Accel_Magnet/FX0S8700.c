...
uint8 initialise_fxos8700()
{
	...
	tmp_byte = 0x00;
	Io_I2c_RegWrite2(I2C0,FXOS8700_I2C_ADDRESS,FXOS8700_CTRL_REG1,&tmp_byte);
	...
	tmp_byte = 0x1F;
	Io_I2c_RegWrite2(I2C0, FXOS8700_I2C_ADDRESS, FXOS8700_M_CTRL_REG1, &tmp_byte);
	...
	tmp_byte = 0x20;
	Io_I2c_RegWrite2(I2C0, FXOS8700_I2C_ADDRESS, FXOS8700_M_CTRL_REG2, &tmp_byte);
	...
	tmp_byte = 0x01;
	Io_I2c_RegWrite2(I2C0, FXOS8700_I2C_ADDRESS, FXOS8700_XYZ_DATA_CFG, &tmp_byte);
...
uint8 Io_FXOS8700CQ_Reset()
{
	...
	if(Io_I2c_RegWrite2(I2C0,FXOS8700_I2C_ADDRESS,FXOS8700_CTRL_REG2, &tmp_byte) != 0)
	{
		return -1;
		//error occurred
	}
